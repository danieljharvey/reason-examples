...
let ans12 = append([1,2,3], [4,5,6]);
/* ans12 == [1,2,3,4,5,6] */
let ans13 = append(["let's","plop","these"],["strings","together"]);
/* ans13 == ["let's", "plop", "these", "strings","together"] */
...
let ans14 = rev_append([3,2,1], [4,5,6]);
/* ans14 == [1,2,3,4,5,6] */
let ans15 = rev_append(["how","this","is"], ["it","works?"]);
/* ans15 == ["is","this","how","it","works?"] */

/* ---CONCAT--- */
let concat: list(list('a)) => list('a);
/* Concatenate a list of lists. The elements of the argument are all concatenated together (in the same order) to give the result. Not tail-recursive (length of the argument + length of the longest sub-list). */

let ans16 = concat([["nice","and"],["tidy"],["now"]]);
/* ans16 == ["nice", "and", "tidy", "now"] */
let ans17 = concat([[1,2,3],[4],[],[5,6]]);
/* ans17 == [1, 2, 3, 4, 5, 6] */

/* ---FLATTEN--- */
let flatten: list(list('a)) => list('a);
/* Same as concat. Not tail-recursive (length of the argument + length of the longest sub-list). */
let ans18 = flatten([["nice","and"],["tidy"],["now"]]);
/* ans18 == ["nice", "and", "tidy", "now"] */
let ans19 = flatten([[1,2,3],[4],[],[5,6]]);
/* ans19 == [1, 2, 3, 4, 5, 6] */
...
iter(str => Js.Log(str), ["hello","from","reason"]);
...
iteri((str,i) => Js.Log(string_of_int(i) ++ str), ["0hello","1from","2reason"]);
...
let ans20 = map(str => str ++ "!!", ["now","i'm","excited"]);
/* ans20 == ["now!!", "i'm!!", "excited!!"]; */

/* the function to apply can be passed in too, like this... */
let addExclaims = str => str ++ "!!!!";
let ans21 = map(addExclaims, ["now","i'm","incredible","excited"]);
/* ans20 == ["now!!!!", "i'm!!!!", "incredibly!!!!", "excited!!!!"]; */
...
let ans22 = mapi((index, item) => {
    string_of_int(index + 1) ++ ": " ++ item;
}, ["List","Of","Things","With","Numbers"]);
/* ans22 == ["1: List", "2: Of", "3: Things", "4: With", "5: Numbers"]; */

let ans23 = mapi((index, item) => index * item, [1,2,3,4,5]);
/* ans23 == [0,2,6,12,20] */
...
let ans24 = rev_map(i => i * 2, [1,2,3,4,5]);
/* ans24 == [10, 8, 6, 4, 2] */
